  ...
  return (
    <ScreenContainer>
      ...
      <View style={styles.card}>
        ...
        <Text style={styles.body}>You can delete your account in Settings. If you cannot access the app, you can use the web deletion page instead.</Text>
      ...
      <Pressable style={styles.secondaryButton} onPress={() => void openExternalUrl(ACCOUNT_DELETION_URL, "Could not open deletion page", "NightRecall could not open the account deletion page right now.")}>
        <Text style={styles.secondaryButtonText}>Open deletion request page</Text>
      </Pressable>
    </ScreenContainer>
  );
}
